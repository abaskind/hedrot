// ADXL345.cpp: ADXL345 I2C device methods
// based on I2Cdev library collection - ADXL345 I2C device class
// adapted for i2c_t3 through the custom code I2Ccom.cpp
...
uint8_t ADXL345::getDeviceID() {
    return readByte(devAddr, ADXL345_RA_DEVID);
}
...
uint8_t ADXL345::getTapThreshold() {
    return readByte(devAddr, ADXL345_RA_THRESH_TAP);
}
/** Set tap threshold.
...
int8_t ADXL345::getOffsetX() {
    return readByte(devAddr, ADXL345_RA_OFSX);
}
/** Set X axis offset.
 * @param x X axis offset value
 * @see getOffset()
...
int8_t ADXL345::getOffsetY() {
    return readByte(devAddr, ADXL345_RA_OFSY);
}
/** Set Y axis offset.
 * @param y Y axis offset value
 * @see getOffset()
...
int8_t ADXL345::getOffsetZ() {
    return readByte(devAddr, ADXL345_RA_OFSZ);
}
/** Set Z axis offset.
 * @param z Z axis offset value
 * @see getOffset()
...
uint8_t ADXL345::getTapDuration() {
    return readByte(devAddr, ADXL345_RA_DUR);
}
/** Set tap duration.
...
uint8_t ADXL345::getDoubleTapLatency() {
    return readByte(devAddr, ADXL345_RA_LATENT);
}
/** Set tap duration.
...
uint8_t ADXL345::getDoubleTapWindow() {
    return readByte(devAddr, ADXL345_RA_WINDOW);
}
...
uint8_t ADXL345::getActivityThreshold() {
    return readByte(devAddr, ADXL345_RA_THRESH_ACT);
}
...
uint8_t ADXL345::getInactivityThreshold() {
    return readByte(devAddr, ADXL345_RA_THRESH_INACT);
}
...
uint8_t ADXL345::getInactivityTime() {
    return readByte(devAddr, ADXL345_RA_TIME_INACT);
}
/** Set inactivity time.
...
bool ADXL345::getActivityAC() {
    return readBit(devAddr, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_ACT_AC_BIT);
}
...
bool ADXL345::getActivityXEnabled() {
    return readBit(devAddr, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_ACT_X_BIT);
}
...
bool ADXL345::getActivityYEnabled() {
    return readBit(devAddr, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_ACT_Y_BIT);
}
...
bool ADXL345::getActivityZEnabled() {
    return     readBit(devAddr, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_ACT_Z_BIT);
}
...
bool ADXL345::getInactivityAC() {
    return readBit(devAddr, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_INACT_AC_BIT);
}
...
bool ADXL345::getInactivityXEnabled() {
    return readBit(devAddr, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_INACT_X_BIT);
}
/** Set X axis activity monitoring inclusion.
...
bool ADXL345::getInactivityYEnabled() {
    return readBit(devAddr, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_INACT_Y_BIT);
}
...
bool ADXL345::getInactivityZEnabled() {
    return readBit(devAddr, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_INACT_Z_BIT);
}
...
uint8_t ADXL345::getFreefallThreshold() {
    return readByte(devAddr, ADXL345_RA_THRESH_FF);
}
...
uint8_t ADXL345::getFreefallTime() {
    return readByte(devAddr, ADXL345_RA_TIME_FF);
}
...
bool ADXL345::getTapAxisSuppress() {
    return readBit(devAddr, ADXL345_RA_TAP_AXES, ADXL345_TAPAXIS_SUP_BIT);
}
...
bool ADXL345::getTapAxisXEnabled() {
    return readBit(devAddr, ADXL345_RA_TAP_AXES, ADXL345_TAPAXIS_X_BIT);
}
...
bool ADXL345::getTapAxisYEnabled() {
    return readBit(devAddr, ADXL345_RA_TAP_AXES, ADXL345_TAPAXIS_Y_BIT);
}
...
bool ADXL345::getTapAxisZEnabled() {
    return readBit(devAddr, ADXL345_RA_TAP_AXES, ADXL345_TAPAXIS_Z_BIT);
}
...
bool ADXL345::getActivitySourceX() {
    return readBit(devAddr, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_ACTX_BIT);
}
...
bool ADXL345::getActivitySourceY() {
    return readBit(devAddr, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_ACTY_BIT);
}
...
bool ADXL345::getActivitySourceZ() {
    return readBit(devAddr, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_ACTZ_BIT);
}
/** Get sleep mode flag.
...
bool ADXL345::getAsleep() {
    return readBit(devAddr, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_ASLEEP_BIT);
}
...
bool ADXL345::getTapSourceX() {
    return readBit(devAddr, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_TAPX_BIT);
}
...
bool ADXL345::getTapSourceY() {
    return readBit(devAddr, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_TAPY_BIT);
}
...
bool ADXL345::getTapSourceZ() {
    return readBit(devAddr, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_TAPZ_BIT);
}
...
bool ADXL345::getLowPowerEnabled() {
    return readBit(devAddr, ADXL345_RA_BW_RATE, ADXL345_BW_LOWPOWER_BIT);
}
...
uint8_t ADXL345::getRate() {
    return readBits(devAddr, ADXL345_RA_BW_RATE, ADXL345_BW_RATE_BIT, ADXL345_BW_RATE_LENGTH);
}
...
bool ADXL345::getLinkEnabled() {
    return readBit(devAddr, ADXL345_RA_POWER_CTL, ADXL345_PCTL_LINK_BIT);
}
...
bool ADXL345::getAutoSleepEnabled() {
    return readBit(devAddr, ADXL345_RA_POWER_CTL, ADXL345_PCTL_AUTOSLEEP_BIT);
}
...
bool ADXL345::getMeasureEnabled() {
    return readBit(devAddr, ADXL345_RA_POWER_CTL, ADXL345_PCTL_MEASURE_BIT);
}
...
bool ADXL345::getSleepEnabled() {
    return readBit(devAddr, ADXL345_RA_POWER_CTL, ADXL345_PCTL_SLEEP_BIT);
}
...
uint8_t ADXL345::getWakeupFrequency() {
    return readBits(devAddr, ADXL345_RA_POWER_CTL, ADXL345_PCTL_WAKEUP_BIT, ADXL345_PCTL_WAKEUP_LENGTH);
}
...
bool ADXL345::getIntDataReadyEnabled() {
    return readBit(devAddr, ADXL345_RA_INT_ENABLE, ADXL345_INT_DATA_READY_BIT);
}
...
bool ADXL345::getIntSingleTapEnabled() {
    return readBit(devAddr, ADXL345_RA_INT_ENABLE, ADXL345_INT_SINGLE_TAP_BIT);
}
/** Set SINGLE_TAP interrupt enabled status.
 * @param enabled New interrupt enabled status
 * @see getIntDataReadyEnabled()
...
bool ADXL345::getIntDoubleTapEnabled() {
    return readBit(devAddr, ADXL345_RA_INT_ENABLE, ADXL345_INT_DOUBLE_TAP_BIT);
}
...
bool ADXL345::getIntActivityEnabled() {
    return readBit(devAddr, ADXL345_RA_INT_ENABLE, ADXL345_INT_ACTIVITY_BIT);
}
/** Set ACTIVITY interrupt enabled status.
 * @param enabled New interrupt enabled status
 * @see getIntDataReadyEnabled()
...
bool ADXL345::getIntInactivityEnabled() {
    return readBit(devAddr, ADXL345_RA_INT_ENABLE, ADXL345_INT_INACTIVITY_BIT);
}
...
bool ADXL345::getIntFreefallEnabled() {
    return readBit(devAddr, ADXL345_RA_INT_ENABLE, ADXL345_INT_FREE_FALL_BIT);
}
...
bool ADXL345::getIntWatermarkEnabled() {
    return readBit(devAddr, ADXL345_RA_INT_ENABLE, ADXL345_INT_WATERMARK_BIT);
}
...
bool ADXL345::getIntOverrunEnabled() {
    return readBit(devAddr, ADXL345_RA_INT_ENABLE, ADXL345_INT_OVERRUN_BIT);
}
...
uint8_t ADXL345::getIntDataReadyPin() {
    return readBit(devAddr, ADXL345_RA_INT_MAP, ADXL345_INT_DATA_READY_BIT);
}
...
uint8_t ADXL345::getIntSingleTapPin() {
    return readBit(devAddr, ADXL345_RA_INT_MAP, ADXL345_INT_SINGLE_TAP_BIT);
}
...
uint8_t ADXL345::getIntDoubleTapPin() {
    return readBit(devAddr, ADXL345_RA_INT_MAP, ADXL345_INT_DOUBLE_TAP_BIT);
}
...
uint8_t ADXL345::getIntActivityPin() {
    return readBit(devAddr, ADXL345_RA_INT_MAP, ADXL345_INT_ACTIVITY_BIT);
}
...
uint8_t ADXL345::getIntInactivityPin() {
    return readBit(devAddr, ADXL345_RA_INT_MAP, ADXL345_INT_INACTIVITY_BIT);
}
...
uint8_t ADXL345::getIntFreefallPin() {
    return readBit(devAddr, ADXL345_RA_INT_MAP, ADXL345_INT_FREE_FALL_BIT);
}
...
uint8_t ADXL345::getIntWatermarkPin() {
    return readBit(devAddr, ADXL345_RA_INT_MAP, ADXL345_INT_WATERMARK_BIT);
}
...
uint8_t ADXL345::getIntOverrunPin() {
    return readBit(devAddr, ADXL345_RA_INT_MAP, ADXL345_INT_OVERRUN_BIT);
}
...
uint8_t ADXL345::getIntDataReadySource() {
    return readBit(devAddr, ADXL345_RA_INT_SOURCE, ADXL345_INT_DATA_READY_BIT);
}
...
uint8_t ADXL345::getIntSingleTapSource() {
    return readBit(devAddr, ADXL345_RA_INT_SOURCE, ADXL345_INT_SINGLE_TAP_BIT);
}
...
uint8_t ADXL345::getIntDoubleTapSource() {
    return readBit(devAddr, ADXL345_RA_INT_SOURCE, ADXL345_INT_DOUBLE_TAP_BIT);
}
...
uint8_t ADXL345::getIntActivitySource() {
    return readBit(devAddr, ADXL345_RA_INT_SOURCE, ADXL345_INT_ACTIVITY_BIT);
}
...
uint8_t ADXL345::getIntInactivitySource() {
    return readBit(devAddr, ADXL345_RA_INT_SOURCE, ADXL345_INT_INACTIVITY_BIT);
}
...
uint8_t ADXL345::getIntFreefallSource() {
    return readBit(devAddr, ADXL345_RA_INT_SOURCE, ADXL345_INT_FREE_FALL_BIT);
}
...
uint8_t ADXL345::getIntWatermarkSource() {
    return readBit(devAddr, ADXL345_RA_INT_SOURCE, ADXL345_INT_WATERMARK_BIT);
}
...
uint8_t ADXL345::getIntOverrunSource() {
    return readBit(devAddr, ADXL345_RA_INT_SOURCE, ADXL345_INT_OVERRUN_BIT);
}
...
uint8_t ADXL345::getSelfTestEnabled() {
    return readBit(devAddr, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_SELFTEST_BIT);
}
...
uint8_t ADXL345::getSPIMode() {
    return readBit(devAddr, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_SPIMODE_BIT);
}
...
uint8_t ADXL345::getInterruptMode() {
    return readBit(devAddr, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_INTMODE_BIT);
}
...
uint8_t ADXL345::getFullResolution() {
    return readBit(devAddr, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_FULL_RES_BIT);
}
...
uint8_t ADXL345::getDataJustification() {
    return readBit(devAddr, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_JUSTIFY_BIT);
}
...
uint8_t ADXL345::getRange() {
    return readBits(devAddr, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_RANGE_BIT, ADXL345_FORMAT_RANGE_LENGTH);
}
...
uint8_t ADXL345::getFIFOMode() {
    return readBits(devAddr, ADXL345_RA_FIFO_CTL, ADXL345_FIFO_MODE_BIT, ADXL345_FIFO_MODE_LENGTH);
}
/** Set FIFO mode.
...
uint8_t ADXL345::getFIFOTriggerInterruptPin() {
    return readBit(devAddr, ADXL345_RA_FIFO_CTL, ADXL345_FIFO_TRIGGER_BIT);
}
...
uint8_t ADXL345::getFIFOSamples() {
    return readBits(devAddr, ADXL345_RA_FIFO_CTL, ADXL345_FIFO_SAMPLES_BIT, ADXL345_FIFO_SAMPLES_LENGTH);
}
...
bool ADXL345::getFIFOTriggerOccurred() {
    return readBit(devAddr, ADXL345_RA_FIFO_STATUS, ADXL345_FIFOSTAT_TRIGGER_BIT);
}
/** Get FIFO length.
...
uint8_t ADXL345::getFIFOLength() {
    return readBits(devAddr, ADXL345_RA_FIFO_STATUS, ADXL345_FIFOSTAT_LENGTH_BIT, ADXL345_FIFOSTAT_LENGTH_LENGTH);
}
