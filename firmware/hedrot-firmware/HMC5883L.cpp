// HMC5883L.cpp: HMC5883L I2C device methods
// based on I2Cdev library collection - HMC5883L I2C device class
...
void HMC5883L::initialize() {
    ...
    //setGain(HMC5883L_GAIN_1090); //le gain de 1090 est trop fort, saturations
    setGain(HMC5883L_GAIN_440);
...
uint8_t HMC5883L::getSampleAveraging() {
    return readBits(devAddr, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_AVERAGE_BIT, HMC5883L_CRA_AVERAGE_LENGTH);
}
...
uint8_t HMC5883L::getDataRate() {
    return readBits(devAddr, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_RATE_BIT, HMC5883L_CRA_RATE_LENGTH);
}
...
uint8_t HMC5883L::getMeasurementBias() {
    return readBits(devAddr, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_BIAS_BIT, HMC5883L_CRA_BIAS_LENGTH);
}
...
uint8_t HMC5883L::getGain() {
    return readBits(devAddr, HMC5883L_RA_CONFIG_B, HMC5883L_CRB_GAIN_BIT, HMC5883L_CRB_GAIN_LENGTH);
}
...
uint8_t HMC5883L::getMode() {
    return readBits(devAddr, HMC5883L_RA_MODE, HMC5883L_MODEREG_BIT, HMC5883L_MODEREG_LENGTH);
}
...
bool HMC5883L::getLockStatus() {
    return readBit(devAddr, HMC5883L_RA_STATUS, HMC5883L_STATUS_LOCK_BIT);
}
...
bool HMC5883L::getReadyStatus() {
    return readBit(devAddr, HMC5883L_RA_STATUS, HMC5883L_STATUS_READY_BIT);
}
