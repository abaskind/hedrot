// ITG3200.cpp: ITG3200 I2C device methods
// based on I2Cdev library collection - ITG3200 I2C device class
...
uint8_t ITG3200::getDeviceID() {
    return readBits(devAddr, ITG3200_RA_WHO_AM_I, ITG3200_DEVID_BIT, ITG3200_DEVID_LENGTH);
}
/** Set Device ID.
...
void ITG3200::setDeviceID(uint8_t id) {
    writeBits(devAddr, ITG3200_RA_WHO_AM_I, ITG3200_DEVID_BIT, ITG3200_DEVID_LENGTH, id);
}
...
uint8_t ITG3200::getRate() {
    return readByte(devAddr, ITG3200_RA_SMPLRT_DIV);
}
/** Set sample rate.
...
void ITG3200::setRate(uint8_t rate) {
    writeByte(devAddr, ITG3200_RA_SMPLRT_DIV, rate);
}
...
uint8_t ITG3200::getFullScaleRange() {
    return readBits(devAddr, ITG3200_RA_DLPF_FS, ITG3200_DF_FS_SEL_BIT, ITG3200_DF_FS_SEL_LENGTH);
}
...
void ITG3200::setFullScaleRange(uint8_t range) {
    writeBits(devAddr, ITG3200_RA_DLPF_FS, ITG3200_DF_FS_SEL_BIT, ITG3200_DF_FS_SEL_LENGTH, range);
}
...
uint8_t ITG3200::getDLPFBandwidth() {
    return readBits(devAddr, ITG3200_RA_DLPF_FS, ITG3200_DF_DLPF_CFG_BIT, ITG3200_DF_DLPF_CFG_LENGTH);
}
...
void ITG3200::setDLPFBandwidth(uint8_t bandwidth) {
    writeBits(devAddr, ITG3200_RA_DLPF_FS, ITG3200_DF_DLPF_CFG_BIT, ITG3200_DF_DLPF_CFG_LENGTH, bandwidth);
}
...
bool ITG3200::getInterruptMode() {
    return readBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_ACTL_BIT);
}
...
void ITG3200::setInterruptMode(bool mode) {
    writeBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_ACTL_BIT, mode);
}
...
bool ITG3200::getInterruptDrive() {
    return readBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_OPEN_BIT);
}
...
void ITG3200::setInterruptDrive(bool drive) {
    writeBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_OPEN_BIT, drive);
}
...
bool ITG3200::getInterruptLatch() {
    return readBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_LATCH_INT_EN_BIT);
}
...
void ITG3200::setInterruptLatch(bool latch) {
    writeBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_LATCH_INT_EN_BIT, latch);
}
...
bool ITG3200::getInterruptLatchClear() {
    return readBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_INT_ANYRD_2CLEAR_BIT);
}
...
void ITG3200::setInterruptLatchClear(bool clear) {
    writeBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_INT_ANYRD_2CLEAR_BIT, clear);
}
...
bool ITG3200::getIntDeviceReadyEnabled() {
    return readBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_ITG_RDY_EN_BIT);
}
...
void ITG3200::setIntDeviceReadyEnabled(bool enabled) {
    writeBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_ITG_RDY_EN_BIT, enabled);
}
...
bool ITG3200::getIntDataReadyEnabled() {
    return readBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_RAW_RDY_EN_BIT);
}
...
void ITG3200::setIntDataReadyEnabled(bool enabled) {
    writeBit(devAddr, ITG3200_RA_INT_CFG, ITG3200_INTCFG_RAW_RDY_EN_BIT, enabled);
}
...
bool ITG3200::getIntDeviceReadyStatus() {
    return readBit(devAddr, ITG3200_RA_INT_STATUS, ITG3200_INTSTAT_ITG_RDY_BIT);
}
...
bool ITG3200::getIntDataReadyStatus() {
    return readBit(devAddr, ITG3200_RA_INT_STATUS, ITG3200_INTSTAT_RAW_DATA_READY_BIT);
}
...
int16_t ITG3200::getTemperature() {
    readBytes(devAddr, ITG3200_RA_TEMP_OUT_H, 2, buffer);
...
void ITG3200::getRotation(int16_t* x, int16_t* y, int16_t* z) {
    readBytes(devAddr, ITG3200_RA_GYRO_XOUT_H, 6, buffer);
...
int16_t ITG3200::getRotationX() {
    readBytes(devAddr, ITG3200_RA_GYRO_XOUT_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
int16_t ITG3200::getRotationY() {
    readBytes(devAddr, ITG3200_RA_GYRO_YOUT_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
int16_t ITG3200::getRotationZ() {
    readBytes(devAddr, ITG3200_RA_GYRO_ZOUT_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
 ...
 */
void ITG3200::reset() {
    writeBit(devAddr, ITG3200_RA_PWR_MGM, ITG3200_PWR_H_RESET_BIT, true);
}
...
bool ITG3200::getSleepEnabled() {
    return readBit(devAddr, ITG3200_RA_PWR_MGM, ITG3200_PWR_SLEEP_BIT);
}
...
void ITG3200::setSleepEnabled(bool enabled) {
    writeBit(devAddr, ITG3200_RA_PWR_MGM, ITG3200_PWR_SLEEP_BIT, enabled);
}
...
bool ITG3200::getStandbyXEnabled() {
    return readBit(devAddr, ITG3200_RA_PWR_MGM, ITG3200_PWR_STBY_XG_BIT);
}
...
void ITG3200::setStandbyXEnabled(bool enabled) {
    writeBit(devAddr, ITG3200_RA_PWR_MGM, ITG3200_PWR_STBY_XG_BIT, enabled);
}
...
bool ITG3200::getStandbyYEnabled() {
    return readBit(devAddr, ITG3200_RA_PWR_MGM, ITG3200_PWR_STBY_YG_BIT);
}
...
void ITG3200::setStandbyYEnabled(bool enabled) {
    writeBit(devAddr, ITG3200_RA_PWR_MGM, ITG3200_PWR_STBY_YG_BIT, enabled);
}
...
bool ITG3200::getStandbyZEnabled() {
    return readBit(devAddr, ITG3200_RA_PWR_MGM, ITG3200_PWR_STBY_ZG_BIT);
}
...
void ITG3200::setStandbyZEnabled(bool enabled) {
    writeBit(devAddr, ITG3200_RA_PWR_MGM, ITG3200_PWR_STBY_ZG_BIT, enabled);
}
...
uint8_t ITG3200::getClockSource() {
    return readBits(devAddr, ITG3200_RA_PWR_MGM, ITG3200_PWR_CLK_SEL_BIT, ITG3200_PWR_CLK_SEL_LENGTH);
}
...
void ITG3200::setClockSource(uint8_t source) {
    writeBits(devAddr, ITG3200_RA_PWR_MGM, ITG3200_PWR_CLK_SEL_BIT, ITG3200_PWR_CLK_SEL_LENGTH, source);
}
